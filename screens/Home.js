...
const LineDivider = () =>{
    return(
        <View style={{width:1,paddingVertical:18}}>
            <View style={{flex:1,borderLeftColor:COLORS.lightGray,borderWidth:1}}>
            ...
            <View style={{flex:1,flexDirection:'row',paddingHorizontal:SIZES.padding,alignItems:'center'}}>
                ...
                >
                    <View
                        ...
                        <View 
                            style={{
                                width: 30, height: 30, alignItems: 'center', justifyContent: 'center', borderRadius: 25, backgroundColor: 'rgba(0,0,0,0.5)'
                        }}> 
                            <Image
            ...
            <View style={{flex:1}}>
                 ...
                 <View style={{paddingHorizontal:SIZES.padding,flexDirection:'row',justifyContent:"space-between"}}>
                     ...
                     <TouchableOpacity onPress={()=>console.log("see more")}>
                        <Text style={{
                            ...FONTS.body3,color:COLORS.lightGray,alignSelf:'flex-start',textDecorationLine:"underline",
                        }}>see more</Text>
                     </TouchableOpacity>
                 </View>
